(() => {
  ...
  var l = {
      ...
      theme:
        'system' === e.getAttribute('data-bs-theme')
          ? c()
          : e.getAttribute('data-bs-theme') || ('system' === r ? c() : r),
      ...
      'sidenav-user': e.hasAttribute('data-sidenav-user') || n,
      position: e.getAttribute('data-layout-position') || d,
      width: e.getAttribute('data-layout-width') || s,
      dir: e.getAttribute('dir') || t,
    },
    i = ((window.defaultConfig = structuredClone(l)), i ? JSON.parse(i) : l);
  if (
    ((window.config = i),
    e.setAttribute('data-skin', i.skin),
    e.setAttribute('data-bs-theme', 'system' === i.theme ? c() : i.theme),
