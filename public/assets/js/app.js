class App {
  ...
  initComponents() {
    try {
      ('undefined' != typeof lucide &&
        'function' == typeof lucide.createIcons &&
        lucide.createIcons(),
  ...
  initPortletCard() {
    (document.querySelectorAll('[data-action="card-close"]').forEach((i) => {
      i.addEventListener('click', (e) => {
        e.preventDefault();
        let t = i.closest('.card');
        t &&
      ...
      document.querySelectorAll('[data-action="card-toggle"]').forEach((i) => {
        i.addEventListener('click', (e) => {
          e.preventDefault();
          e = i.closest('.card');
          let t = e ? e.querySelector('.card-body') : null;
          e &&
            t &&
            ((t.style.transition =
              'height 0.35s ease-in-out, margin 0.35s ease-in-out'),
      ...
      document.querySelectorAll('[data-action="card-refresh"]').forEach((e) => {
        e.addEventListener('click', (t) => {
          t.preventDefault();
          var i,
            t = e.closest('.card');
          if (t) {
            let e = t.querySelector('.card-overlay');
            (e ||
              (((e = document.createElement('div')).className = 'card-overlay'),
      ...
      document
        .querySelectorAll('[data-action="code-collapse"]')
        .forEach((i) => {
          i.addEventListener('click', (e) => {
            e.preventDefault();
            var e = i.closest('.card');
            let t = e ? e.querySelector('.code-body') : null;
            e &&
              t &&
              ((t.style.transition = 'height 0.35s ease-in-out'),
              'none' === window.getComputedStyle(t).display
                ...
                : ((t.style.height = t.scrollHeight + 'px'),
                  ...
                  t.addEventListener(
                    'transitionend',
                    () => {
                      ((t.style.display = 'none'), (t.style.height = null));
                    },
                    { once: !0 },
                  )));
          });
    ...
    let t = new IntersectionObserver(
      (e, n) => {
        e.forEach((s) => {
          if (s.isIntersecting) {
            let a = s.target;
            s = a.getAttribute('data-target');
            if (s) {
              let e = s.replace(/,/g, ''),
                t = ((e = parseFloat(e)), 0),
                i,
                o =
                  ((i = Number.isInteger(e) ? Math.floor(e / 25) : e / 25),
                  () => {
                    t < e
                      ? ((t += i) > e && (t = e),
                        (a.innerText = r(t)),
  ...
  initToggle() {
    document.querySelectorAll('[data-toggler]').forEach((e) => {
      let t = e.querySelector('[data-toggler-on]'),
        ...
        o = 'on' === e.getAttribute('data-toggler'),
        a = () => {
          o
            ? (t?.classList.remove('d-none'), i?.classList.add('d-none'))
            : (t?.classList.add('d-none'), i?.classList.remove('d-none'));
        };
  ...
  initSidenavMenu() {
    ...
    if (s) {
      ...
      let a = s.querySelectorAll('li .collapse'),
        e =
          (a.forEach((e) => {
            e.addEventListener('show.bs.collapse', (e) => {
              let t = e.target,
                ...
                o = t.parentElement;
              for (; o && o !== s; )
                (o.classList.contains('collapse') && i.push(o),
                  (o = o.parentElement));
              a.forEach((e) => {
                e === t ||
                  i.includes(e) ||
      ...
      (s.querySelectorAll('a').forEach((t) => {
        if (t.href === e) {
          ...
          for (; e && e !== s; ) {
            ...
            var i = e.closest('.collapse');
            e = i
              ? (new bootstrap.Collapse(i, { toggle: !1 }).show(),
                (i = i.closest('li')) && i.classList.add('active'),
                i)
              : e.parentElement;
          }
        }
  ...
  initHorizontalMenu() {
    var o = document.querySelector('.navbar-nav');
    if (o) {
      let t = window.location.href.split(/[?#]/)[0];
      o.querySelectorAll('li a').forEach((e) => {
        if (e.href === t) {
          e.classList.add('active');
  ...
  initTopbar() {
    let e = document.querySelector('.app-topbar');
    e &&
...
let skinPresets = {
  default: { theme: 'light', sidenavColor: 'dark', sidenavUser: !1 },
  minimal: {
    theme: 'light',
    sidenavColor: 'gray',
    topbarColor: 'gray',
...
class LayoutCustomizer {
  ...
  applyPreset(e) {
    ...
    e &&
      (e.theme &&
        ...
        this.activeThemeDropdownItem()),
      e.topbarColor &&
        ((this.config['topbar-color'] = e.topbarColor),
        this.html.setAttribute('data-topbar-color', e.topbarColor)),
      e.sidenavColor &&
        ((this.config['sidenav-color'] = e.sidenavColor),
        this.html.setAttribute('data-menu-color', e.sidenavColor)),
      e.sidenavSize &&
        ((this.config['sidenav-size'] = e.sidenavSize),
        this.html.setAttribute('data-sidenav-size', e.sidenavSize)),
      void 0 !== e.sidenavUser) &&
      ((this.config['sidenav-user'] = e.sidenavUser),
      e.sidenavUser
    ...
    var e = (e, t) => {
      ...
      e =
        ...
        e('input[name="data-sidenav-size"]', (e) =>
          this.changeSidenavSize(e.value),
        ),
        ...
        e('input[name="data-layout-width"]', (e) =>
          this.changeLayoutWidth(e.value),
        ),
        e('input[name="dir"]', (e) => this.changeLayoutDirection(e.value)),
  ...
  _adjustLayout() {
    var e = window.innerWidth,
      t = this.config['sidenav-size'];
    e <= 767.98
      ? this.changeSidenavSize('offcanvas', !1)
      : e <= 1140 && !['offcanvas'].includes(t)
        ? this.changeSidenavSize('condensed', !1)
        : this.changeSidenavSize(t);
  }
  initWindowSize() {
    window.addEventListener('resize', () => this._adjustLayout());
  }
  activeThemeDropdownItem() {
    var e = document.querySelectorAll('.dropdown-item [name="data-bs-theme"]');
    let o = this.config.theme;
    e &&
      0 < e.length &&
      e.forEach((e) => {
        var t,
          i = e.value === o;
        (e.parentElement.classList.toggle('active', i),
          i &&
            ((e = document.getElementById('theme-icon-light')),
            (i = document.getElementById('theme-icon-dark')),
            (t = document.getElementById('theme-icon-system')),
            e && e.classList.toggle('d-none', 'light' !== o),
            i && i.classList.toggle('d-none', 'dark' !== o),
            t) &&
            t.classList.toggle('d-none', 'system' !== o));
      });
  }
}
class Plugins {
  ...
  initFlatPicker() {
    document.querySelectorAll('[data-provider]').forEach((e) => {
      var t = e.getAttribute('data-provider'),
        i = e.attributes,
        o = { disableMobile: !0, defaultDate: new Date() };
      'flatpickr' === t
        ? (i['data-date-format'] &&
            (o.dateFormat = i['data-date-format'].value),
          i['data-enable-time'] &&
            ((o.enableTime = !0), (o.dateFormat += ' H:i')),
          i['data-altFormat'] &&
            ((o.altInput = !0), (o.altFormat = i['data-altFormat'].value)),
          i['data-minDate'] && (o.minDate = i['data-minDate'].value),
          i['data-maxDate'] && (o.maxDate = i['data-maxDate'].value),
          i['data-default-date'] &&
            (o.defaultDate = i['data-default-date'].value),
          i['data-multiple-date'] && (o.mode = 'multiple'),
          i['data-range-date'] && (o.mode = 'range'),
          i['data-inline-date'] &&
            ((o.inline = !0), (o.defaultDate = i['data-default-date'].value)),
          i['data-disable-date'] &&
            (o.disable = i['data-disable-date'].value.split(',')),
          i['data-week-number'] && (o.weekNumbers = !0),
          flatpickr(e, o))
        : 'timepickr' === t &&
          ((o = {
            enableTime: !0,
          ...
          i['data-time-hrs'] && (o.time_24hr = !0),
          i['data-min-time'] && (o.minTime = i['data-min-time'].value),
          i['data-max-time'] && (o.maxTime = i['data-max-time'].value),
          i['data-default-time'] &&
            (o.defaultDate = i['data-default-time'].value),
          i['data-time-inline'] &&
            ((o.inline = !0), (o.defaultDate = i['data-time-inline'].value)),
          flatpickr(e, o));
    });
  }
  initTouchSpin() {
        ...
        l.hasAttribute('readonly') ||
          (r &&
            r.addEventListener('click', () => {
              var e = s() - 1;
              (!o || e >= t) && (l.value = e.toString());
            }),
          n &&
            n.addEventListener('click', () => {
              var e = s() + 1;
              (!a || e <= i) && (l.value = e.toString());
            }));
      }
    });
  }
...
class I18nManager {
  constructor({
    ...
    langCodeSelector: o = '#selected-language-code',
    translationKeySelector: a = '[data-lang]',
    translationKeyAttribute: s = 'data-lang',
    languageSelector: r = '[data-translator-lang]',
  } = {}) {
    ((this.selectedLanguage = sessionStorage.getItem('__THEME_LANG__') || e),
      (this.langPath = t),
      (this.langImageSelector = i),
      (this.langCodeSelector = o),
      (this.translationKeySelector = a),
  ...
  async init(e) {
    ('ar' === this.selectedLanguage && e.changeLayoutDirection('rtl'),
      await this.applyTranslations(),
      this.updateSelectedImage(),
      this.updateSelectedCode(),
      this.bindLanguageSwitchers(e));
  }
  ...
  async applyTranslations() {
    let o = await this.loadTranslations();
    document.querySelectorAll(this.translationKeySelector).forEach((e) => {
      var t = e.getAttribute(this.translationKeyAttribute),
        i = ((i = o), t.split('.').reduce((e, t) => e?.[t] ?? null, i));
      i ? (e.innerHTML = i) : console.warn('Missing translation for key: ' + t);
    });
  }
  setLanguage(e) {
    ((this.selectedLanguage = e),
      sessionStorage.setItem('__THEME_LANG__', e),
  ...
  bindLanguageSwitchers(i) {
    this.languageButtons.forEach((t) => {
      t.addEventListener('click', () => {
        var e = t.dataset.translatorLang;
        e &&
          e !== this.selectedLanguage &&
          (this.setLanguage(e), i) &&
          i.changeLayoutDirection('ar' === e ? 'rtl' : 'ltr');
      });
    });
  }
}
document.addEventListener('DOMContentLoaded', function (e) {
  (new App().init(), new Plugins().init());
  var t = new LayoutCustomizer();
  (t.init(), new I18nManager().init(t));
});
let theme = (e, t = 1) => {
  var i = getComputedStyle(document.documentElement)
    .getPropertyValue('--theme-' + e)
    .trim();
    ...
    if (this.element) {
      ...
      if (e) {
        e = e
          .split(',')
          .map((e) => e.trim())
          .map((e) => (e.startsWith('#') || e.includes('rgb') ? e : theme(e)));
    ...
    return (
      'boxplot' === e.chart?.type?.toLowerCase() &&
        ...
        (e.plotOptions.boxPlot.colors.upper =
          e.plotOptions.boxPlot.colors.upper || i[0]),
        (e.plotOptions.boxPlot.colors.lower =
          e.plotOptions.boxPlot.colors.lower || i[1])),
      Array.isArray(e.yaxis) &&
        e.yaxis.forEach((e, t) => {
          t = i[t] || this.colors[t] || '#999';
      ...
      e.markers && !e.markers.strokeColor && (e.markers.strokeColor = i),
      'gradient' === e.fill?.type &&
        e.fill.gradient &&
        (e.fill.gradient.gradientToColors =
          e.fill.gradient.gradientToColors || i),
  ...
  static getDefaultOptions() {
    ...
    return {
      ...
      scales: {
        ...
        y: {
          ticks: { font: { family: e }, color: theme('secondary-color') },
          grid: {
            display: !0,
            drawBorder: !1,
      ...
      ((this.element =
        ...
        this.element
          ? (this.chart && this.chart.destroy(),
            ({ type: e, data: t, options: i, plugins: o } = this.getOptions()),
