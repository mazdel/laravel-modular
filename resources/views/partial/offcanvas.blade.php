<div class="offcanvas offcanvas-end overflow-hidden"
    ...
    <div class="offcanvas-body theme-customizer-bar p-0 h-100"
        data-simplebar="">
        ...
        <div class="p-3 border-bottom border-dashed"
            ...
            <div class="row g-3">
                ...
                <div class="col-4"
                    id="sidenav-size-on-hover-active">
                    <div class="form-check sidebar-setting card-radio">
                        <input class="form-check-input"
                    ...
                    <h5 class="mb-0 fs-base text-center text-muted mt-2">
                        On Hover - Show
                    </h5>
                </div>

                <div class="col-4"
                    id="sidenav-size-offcanvas">
                    <div class="form-check sidebar-setting card-radio">
                        <input class="form-check-input"
