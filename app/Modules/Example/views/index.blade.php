...
@php
    $breadcrumb = [
        ['title' => 'Home', 'link' => '/'],
        ['title' => 'Dashboard', 'link' => '/example'],
        ['title' => 'eEcommerce', 'link' => '#'],
    ];
@endphp
@section('breadcrumb')
    @json($breadcrumb)
...
@section('meta-description', 'Dashboard')
@section('meta-keywords', 'Dashboard, Laravel')
@section('content')
    <div class="row">
        <div class="col-xxl-5">
            <div class="row h-100">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <div class="overflow-hidden flex-shrink-0">
                                    <h3 class="fw-normal text-reset fs-20 lh-base">
                                        <span class="text-muted fs-base text-uppercase h5">Good
                                            Day,</span>
                                        <br />
                                        <b>David Dev!</b>
                                    </h3>
                        ...
                        <div class="card-body d-flex align-items-center p-2 bg-light bg-opacity-50">
                            <p class="d-flex align-items-center justify-content-between w-100 mb-0">
                                ...
                                <span class="text-nowrap"><i
                                        class="ti ti-clock fs-15 align-middle"></i><span
                                        class="align-middle ms-1 fw-semibold"
                                        id="clock-widget"></span></span>
                            </p>
                        </div>
                        <!-- end card-body -->
                    </div>
                    ...
                    <div class="card card-h-100">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h5 class="text-muted fs-base text-uppercase"
                                        title="Number of Orders">
                                        Orders
                                    </h5>
                                    <h3 class="my-3 py-1 fw-semibold">
                                        <span data-target="9,754">0</span>
                                    </h3>
                                    <p class="mb-0 text-muted">
                                        <span class="text-danger me-2"><i class="ti ti-arrow-down"></i>
                                            1.89%</span>
                                        <span class="text-nowrap">Since last
                                            month</span>
                                    </p>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <h3 class="my-3 py-1 fw-semibold">
                                        $<span data-target="75.21">0</span>k
                                    </h3>
                                    <p class="mb-0 text-muted">
                                        <span class="text-danger me-2"><i class="ti ti-arrow-down"></i>
                                            5.23%</span>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <p class="mb-0 text-muted">
                                        <span class="text-success me-2"><i class="ti ti-arrow-up"></i>
                                            4.87%</span>
                                        <span class="text-nowrap">Since last
                                            month</span>
                                    </p>
                        ...
                        <div class="card-header justify-content-between">
                            ...
                            <div>
                                <a class="btn btn-sm btn-default"
                                    ...
                                    href="index.html#"><i class="ti ti-refresh me-1"></i> Refresh</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div dir="ltr">
                                <div class="apex-charts"
                                    id="total-sales-chart"></div>
                            </div>
                            <div class="text-center mb-1">
                                <span
                                    class="badge badge-outline-light text-dark p-1 px-2 rounded-pill fs-12"><i
                                        class="ti ti-star-filled text-danger me-1"></i>
                                    POOR SALES</span>
                            </div>
                        </div>
                        <!-- end card-body-->
                ...
                <div class="col-lg-6">
                    <div class="card card-h-100">
                        ...
                        <div class="card-body">
                            <div dir="ltr">
                                <div class="apex-charts"
                                    id="weekly-performance-chart"></div>
                            </div>
                        </div>
                        <!-- end card-body-->
                    </div>
    ...
    <div class="row">
            ...
            <div class="card card-h-100">
                <div class="card-header border-dashed card-tabs">
                    <div class="flex-grow-1">
                        <h4 class="card-title">
                            Sales Report
                            <span class="text-muted fs-base fw-normal">(25822
                                Orders)</span>
                        </h4>
                    </div>
                    ...
                    <div class="p-3 pt-1">
                        <div class="dash-item-overlay d-none d-md-block"
                            ...
                            <p class="text-muted mb-0 mt-2">
                                Property PS007 is not receiving hits. Either your site
                                is not receiving any sessions.
                            </p>
                        </div>
                        <div dir="ltr">
                            <div class="apex-charts"
                                id="sales-report-chart"></div>
                        </div>
                    </div>
                </div>
                <!-- end card-body-->
        ...
        <div class="col-xxl-6">
            <div class="card card-h-100"
                data-table
                data-table-rows-per-page="6">
                <div class="card-header justify-content-between">
                    <h4 class="card-title">Top Selling Products</h4>
                    <div>
                        <a class="btn btn-sm btn-default"
                            href="index.html#"><i class="ti ti-cloud-upload me-1"></i>
                            Export</a>
                        <a class="btn btn-sm btn-light"
                            href="index.html#"><i class="ti ti-download me-1"></i>
                            Import</a>
                    </div>
                </div>
                <div class="card-body p-0">
                        ...
                        <table class="table table-custom table-centered table-hover w-100 mb-0">
                            <tbody class="text-nowrap">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="m-0 fs-base">Modern Fabric Sofa Set
                                        </h5>
                                        <span class="text-muted fs-xs">By:
                                            Homeluxe</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-warning-subtle text-warning px-2 py-1 rounded-pill fs-12">
                                            Low Stock
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="m-0 fs-base">L-Shaped Sectional
                                            Sofa</h5>
                                        <span class="text-muted fs-xs">By:
                                            ComfortHub</span>
                                    </td>
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-success-subtle text-success px-2 py-1 rounded-pill fs-12">
                                            In Stock
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="m-0 fs-base">Velvet Recliner Chair
                                        </h5>
                                        <span class="text-muted fs-xs">By:
                                            SoftEase</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-danger-subtle text-danger px-2 py-1 rounded-pill fs-12">
                                            Out of Stock
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="m-0 fs-base">Minimalist TV Stand
                                        </h5>
                                        <span class="text-muted fs-xs">By:
                                            FurniPro</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="m-0 fs-base">Leather Lounge Chair
                                        </h5>
                                        <span class="text-muted fs-xs">By:
                                            UrbanStyle</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="m-0 fs-base">Glass Center Table
                                        </h5>
                                        <span class="text-muted fs-xs">By:
                                            CrystalCasa</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="m-0 fs-base">Wooden Bookshelf Unit
                                        </h5>
                                        <span class="text-muted fs-xs">By:
                                            TimberWorks</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="m-0 fs-base">Luxury King Bed Frame
                                        </h5>
                                        <span class="text-muted fs-xs">By:
                                            DreamRest</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="m-0 fs-base">Round Dining Table Set
                                        </h5>
                                        <span class="text-muted fs-xs">By:
                                            CasaDine</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="m-0 fs-base">Ergonomic Office Chair
                                        </h5>
                                        <span class="text-muted fs-xs">By:
                                            WorkEase</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="m-0 fs-base">Nightstand with
                                            Drawers</h5>
                                        <span class="text-muted fs-xs">By:
                                            CozyHome</span>
                                    </td>
        ...
        <div class="col-xxl-5">
            <div class="card card-h-100"
                ...
                <div class="card-header justify-content-between">
                    <h4 class="card-title">
                        Recent Orders
                        <span class="text-muted fs-base fw-normal">(186.25k
                            Transactions)</span>
                    </h4>
                    <div>
                        <a class="btn btn-sm btn-default"
                            href="index.html#">
                            <i class="ti ti-cloud-upload me-1"></i> Export
                        </a>
                        <a class="btn btn-sm btn-light"
                            href="index.html#">
                            ...
                            <div class="dropdown ms-auto">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item"
                                            href="index.html#">
                                            <i class="ti ti-map me-2"></i> View Full
                                            Map
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a class="dropdown-item"
                                            href="index.html#">
                                            <i class="ti ti-filter-2 me-2"></i> Filter
                                            By
                                            Region
                                        </a>
                                    </li>
                            ...
                            <div class="mt-3">
                                <div class="p-2 mb-3 border-dashed border rounded">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-lg flex-shrink-0 me-2">
                                            <span
                                                class="avatar-title bg-warning-subtle rounded-circle fs-1">
                                ...
                                <div class="d-flex align-items-center mb-2 gap-2">
                                    ...
                                    <p class="mb-0 ms-auto">
                                        <span class="fw-semibold">$48.6k</span>
                                ...
                                <div class="d-flex align-items-center mb-2 gap-2">
                                    ...
                                    <p class="mb-0 ms-auto">
                                        <span class="fw-semibold">$26.4k</span>
                                        <span class="text-muted">Revenue</span>
                                    </p>
                                </div>
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>Australia</div>
                                    <p class="mb-0 ms-auto">
                                        <span class="fw-semibold">$18.9k</span>
                                        <span class="text-muted">Revenue</span>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="dropdown ms-auto">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item"
                                            href="index.html#">
                                            <i class="ti ti-activity me-2"></i> View
                                            Activity
                                            Log
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a class="dropdown-item text-danger"
                                            href="index.html#">
                                            <i class="ti ti-trash me-2"></i> Clear
                                            Activity
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class="timeline timeline-users">
                                ...
                                <div class="timeline-item d-flex align-items-stretch">
                                    ...
                                    <div class="timeline-content ps-3 pb-4">
                                        <h5 class="mb-1">
                                            New Orders Synced from Storefront
                                        </h5>
                                        <p class="mb-1 text-muted">
                                            1,250 new customer orders were successfully
                                            imported from the online store.
                                        </p>
                                        <span class="text-primary fw-semibold">By
                                            Olivia Green</span>
                                    </div>
                                </div>
                                ...
                                <div class="timeline-item d-flex align-items-stretch">
                                    ...
                                    <div class="timeline-content ps-3 pb-4">
                                        ...
                                        <p class="mb-1 text-muted">
                                            Stripe API upgraded to support faster
                                            settlements
                                            and improved security tokens.
                                        </p>
                                        <span class="text-primary fw-semibold">By
                                            James Parker</span>
                                    </div>
                                ...
                                <div class="timeline-item d-flex align-items-stretch">
                                    ...
                                    <div class="timeline-content ps-3 pb-4">
                                        <h5 class="mb-1">Inventory Levels
                                            Auto-Synced</h5>
                                        <p class="mb-1 text-muted">
                                            All product quantities were updated based on
                                            the
                                ...
                                <div class="timeline-item d-flex align-items-stretch">
                                    ...
                                    <div class="timeline-content ps-3 pb-4">
                                        <h5 class="mb-1">New Vendor Accounts
                                            Approved</h5>
                                        <p class="mb-1 text-muted">
                                            Five new seller accounts were verified and
                                            added
                                            to the marketplace.
                                        </p>
                                        <span class="text-primary fw-semibold">By Liam
                                            Johnson</span>
                                    </div>
                                </div>
                                ...
                                <div class="timeline-item d-flex align-items-stretch">
                                    ...
                                    <div class="timeline-content ps-3 pb-4">
                                        <h5 class="mb-1">Refund Requests Reviewed
                                        </h5>
                                        <p class="mb-1 text-muted">
                                            27 refund claims were processed successfully
                                            with
                                ...
                                <div class="timeline-item d-flex align-items-stretch">
                                    ...
                                    <div class="timeline-content ps-3">
                                        <h5 class="mb-1">Summer Campaign Launched
                                        </h5>
                                        <p class="mb-1 text-muted">
                                            The “Summer Deals 2025” campaign is now live
                                            across all marketing channels.
                                        </p>
                                        <span class="text-primary fw-semibold">By Ava
                                            Mitchell</span>
                                    </div>
                                </div>
                            </div>
